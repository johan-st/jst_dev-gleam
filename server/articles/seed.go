	...
	return Article{
		...
		Content: []Content{
			Block(
				...
				List(
					Link("/404_not-found", Text("404 page, internal link")),
					LinkExternal("https://gleam.run", Text("Gleam, external link")),
					Link("https://gleam.run/logo.png", Image("https://gleam.run/logo.png", "Gleam Logo")),
				),
			),
			Block(
				Paragraph(
					Text("This is a paragraph with a list inside it. It is "),
					Link("#booop", Text("here")),
