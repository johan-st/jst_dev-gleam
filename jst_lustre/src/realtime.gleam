...
pub fn kv_sub(sock: ws.WebSocket, bucket: String, pattern: option.Option(String)) -> Effect(OutMsg) {
...
pub fn js_sub(sock: ws.WebSocket, stream: String, start_seq: Int, batch: Int, filter: String) -> Effect(OutMsg) {
...
pub fn cmd(sock: ws.WebSocket, target: String, inbox: String, payload: json.Json) -> Effect(OutMsg) {
  let data = payload
